...
--
-- Test 1: CH_A (0000), dac_val = 0xABC  -> expect frame 0x030ABC00
-- Test 2: CH_B (0001), dac_val = 0x7FF  -> expect frame 0x0317FF00
----------------------------------------------------------------------------------
library IEEE;
...
begin
  ...
  begin
    ...
    -- Test 1: CH_A (0000), dac_val = 0xABC → expected frame 0x030ABC00
    CHANNEL <= "0000";
    dac_val <= x"ABC";
    wait for CLK_PER;
    ...
    -- Test 2: CH_B (0001), dac_val = 0x7FF → expected frame 0x0317FF00
    CHANNEL <= "0001";
    dac_val <= x"7FF";
